...
public class BjorklundGenerator2 {
	...
	private static ArrayList<Boolean> bjorklund( ArrayList<ArrayList<Boolean>> bigArray,
		ArrayList<ArrayList<Boolean>> smallArray ) {
		/** Done. */
		...
		// printArrays ( bigArray, smallArray );
		...
		// printArrays ( newBigArray, newSmallArray );
