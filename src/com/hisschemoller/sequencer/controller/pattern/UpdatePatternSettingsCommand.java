				...
				try {
					...
					for(int i = 0; i < n; i++) {
						if( pattern.get( i ) == true ) {
							...
							message.setMessage( sourceMessage.getStatus(), sourceMessage.getChannel(),
								sourceMessage.getData1(), sourceMessage.getData2() );
					...
					System.out.println(
						"UpdatePatternSettingsCommand.execute() InvalidMidiDataException: " + exception.getMessage() );
				}
