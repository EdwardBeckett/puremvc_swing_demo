...
public class StartupCommand extends SimpleCommand implements ICommand {
	...
	public final void execute( INotification notification ) {
		...
		sendNotification( SeqNotifications.ENABLE_MIDI_OUT_DEVICE,
			EPGPreferences.getBoolean( EPGPreferences.MIDI_OUT_ENABLED, true ) );
		sendNotification( SeqNotifications.ENABLE_OSC_DEVICE,
			EPGPreferences.getBoolean( EPGPreferences.OSC_ENABLED, true ) );
